...
switch (action) {
	// начало новой игры
	case "startNewGm":
		alarm[1] = 2 * fps;	// время пребывания в комнате псевдо загрузки игры
	...
	case "player_death_FP":
		alarm[1] = 2 * fps;	// время на проигрывание спрайта смерти
	...
	case "goTo_rmPixel":
		alarm[1] = 0.05 * fps;	// время на загрузку пикселей
