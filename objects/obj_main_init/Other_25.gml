/// @description системные объекты и контроллеры

instance_create_depth(-10000, 0, 0, obj_ctrl_set);
instance_create_depth(-10000, 0, 0, obj_ctrl_camera);

instance_create_depth(-10000, 0, 0, obj_ctrl_dlg);
