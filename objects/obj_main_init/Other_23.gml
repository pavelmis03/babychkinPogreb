...
{//ОПИСАНИЕ ПОВЕРХНОСТЕЙ
	//"Поверхность" - коэффициент скорости для игрока, [КС для буханки, износ на 10км], КС для владимира, КС для монстров]
global.CONST_MAP_SURF[?""] = [1, [0.5, 1], 1, 1];
global.CONST_MAP_SURF[?"Паркет"] = [1, [0.5, 1], 1, 1];
global.CONST_MAP_SURF[?"Бетон"] = [1, [1.5, 1], 1, 1];
...
global.CONST_MAP_SURF[?"Лед"] = [1, [1.5, 1], 1, 1];
global.CONST_MAP_SURF[?"Мокрая земля"] = [1, [1.5, 1], 1, 1];
