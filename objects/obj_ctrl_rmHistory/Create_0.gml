...
btn_id1 = scr_btn_create(room_width * 0.32, room_height * 0.88, spr_btn_history_next1, depth, 0, "historyNextImg", "func", [20, "snd_gm_btnEnter", "snd_gm_btnClick"]);
/*
...
btn_id1.sound = [20, "snd_gm_btnEnter", "snd_gm_btnClick"];
btn_id1.btn_enable = true;
*/	
// кнопка ,,предыдущий слайд,,
btn_id2 = scr_btn_create(room_width * 0.19, room_height * 0.88, spr_btn_history_pre1, depth, 0, "historyPreImg", "func", [20, "snd_gm_btnEnter", "snd_gm_btnClick"]);
/*
...
btn_id2.sound = [20, "snd_gm_btnEnter", "snd_gm_btnClick"];
*/
