...
// инвентарь
ctrl_dlg_map_txt[?"invDelCell"] = @"Выбросить все предметы из этой ячейки?";
ctrl_dlg_map_txt[?"invDelCell_other"] = @"Выбросить все предметы из этой ячейки?";
ctrl_dlg_map_txt[?"invPlotItem"] = @"Это еще может мне пригодиться";
ctrl_dlg_map_txt[?"invTakeAll"] = @"Уверен, что хочешь взять все?";
ctrl_dlg_map_txt[?"invPutAll"] = @"Весь рюкзак сюда вытряхиваем? Точно?";