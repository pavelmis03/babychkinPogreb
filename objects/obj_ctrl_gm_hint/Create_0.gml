...
//привязки и сюжетки
ctrl_hint_hint_map[?"hint_hole1"] = ["Мой рабочий день еще не закончен.\nЯ пока не могу уйти", 200, 4, 0];	 //подсказка с уровня офиса ,,холл,, о том, что выйти из здания еще нельзя
ctrl_hint_hint_map[?"hint_torture1"] = ["Воу-воу! Это допросная!\nМы визит сюда ещё не заслужили!", 200, 4, 0];	 //подсказка с уровня офиса ,,допросная,,
