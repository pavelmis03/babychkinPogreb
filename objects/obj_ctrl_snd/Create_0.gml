...
//массив идентификаторов включенных звуков
//ctrl_snd_arr_on = [];	//пока нужен только для того, чтобы останавливать звуки при переходе в другую комнату
...
ctrl_msc_map[?"rm_menu_ldGm"] = [50, "msc_menu_mm1"];
ctrl_msc_map[?"rm_menu_newGm"] = [50, "msc_menu_mm1"];
ctrl_msc_map[?"rm_menu_endless"] = [50, "msc_menu_mm1"];
ctrl_msc_map[?"rm_menu_newGm_start"] = [50, "msc_menu_mm1"];
...
ctrl_msc_map[?"rm_menu_editor"] = [50, "msc_menu_mm1"];
//game menu
ctrl_msc_map[?"rm_menu_pause"] = [50, "snd_none"];
ctrl_msc_map[?"rm_menu_lvlEnd"] = [50, "snd_none"];
ctrl_msc_map[?"rm_menu_deathFP"] = [50, "snd_none"];
