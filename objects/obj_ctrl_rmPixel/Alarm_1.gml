...
//сколько клеток нужно добавлять, чтобы уложиться в указанное времмя
...
for (var i = 0; i < kol; i++) {
	...
	} else { //если мы только что заполнили весь экран, начинаем уего опустошать, причем в два раза быстрее
		if (!ctrl_pixelRm_full) {
