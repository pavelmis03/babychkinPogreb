...
x += real(obj_ctrl_set.ctrl_set_map_curr[?"music_val"]) - sprite_get_width(spr_btn_other_slider1) / 2;
val = real(obj_ctrl_set.ctrl_set_map_curr[?"music_val"]);

//drawing
draw_txt = "Громкость музыки";
draw_txt_cl = c_black;
